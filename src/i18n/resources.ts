...
export const es = {
  ...
  dzFormats: 'PDF hasta 4MB · DOCX · MD · TXT',
  upTooBig: 'PDF demasiado grande (máx. 4MB)', upLimit: 'Límite de subidas por hoy',
  upNoText: 'El PDF no tiene texto extraíble', upFailed: 'No se pudo indexar',
  /* composer */
...
export const en: typeof es = {
  ...
  dzFormats: 'PDF up to 4MB · DOCX · MD · TXT',
  upTooBig: 'PDF too large (4MB max)', upLimit: 'Upload limit reached for today',
  upNoText: 'No extractable text in this PDF', upFailed: 'Indexing failed',
